  ...
  <div>
    ...
    <section class="relative text-white section-padding overflow-hidden"
      ...
      <div class="relative z-10 container-custom px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-base sm:text-lg md:text-xl text-primary-100 animate-fade-in-up-delay">Nous sommes là pour
    ...
    <section class="section-padding bg-gray-50">
      <div class="container-custom px-4 sm:px-6 lg:px-8">
        <div class="rounded-lg overflow-hidden shadow-lg" style="height: 450px;">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.5213509955042!2d1.1868063147866659!3d6.19472932861648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMTEnNDEuMCJOIDHCsDExJzIwLjQiRQ!5e0!3m2!1sfr!2stg!4v1507824169975"
    ...
    <section class="section-padding bg-white">
      <div class="container-custom px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
          <!-- Formulaire -->
          <div>
            <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-4 md:mb-6">Envoyez-nous un message</h2>
            ...
            <div v-if="submitted" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              <p class="text-green-800">Merci ! Votre message a été envoyé avec succès. Nous vous répondrons dans les
                plus brefs délais.</p>
            </div>
          </div>
          ...
          <div>
            <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-4 md:mb-6">Informations de contact</h2>
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@isagestogo.com" class="text-primary-600 hover:text-primary-700">
